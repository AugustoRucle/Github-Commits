...
/**
 * @description A reusable Hidden Eye SVG component with dynamic width, height, and color props.
 *
 ...
 */
export const HiddenEyeSvg: React.FC<HiddenEyeSvgProps> = ({
  width = 512,
  height = 512,
  color = '#000000',
}) => {
